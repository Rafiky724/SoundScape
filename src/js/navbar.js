...
//Modal en caso de intentar crear un Home Studio sin tener una sesión activa
...
//Función que permite cerrar sesión al botón
...
//Función que se encarga de cargar los datos del usuario en caso de tener una sesión activa
